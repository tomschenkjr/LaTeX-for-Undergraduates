...
%\begin{slide}{Why \LaTeX\mbox{}?}
%\begin{itemstep}
%	\item Microsoft Word, Corel Wordperfect, and OpenOffice are also document preparation programs, so why \LaTeX\mbox{}?
%	\FromSlide{2} \item \href{www.drake.edu}{two}
%	\FromSlide{3} \item three
%	\FromSlide{4} \item four
%\end{itemize}
%\end{slide}
%}
